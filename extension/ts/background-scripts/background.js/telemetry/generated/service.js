...
(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    service = factory(webext.Glean);
  } else {
    // Browser globals (root is window)
    if (!root["gleanAssets"]) {
      root["gleanAssets"] = {};
    }
    root["gleanAssets"]["service"] = factory(root.webext);
  }
  ...
  return {
     ...
     */
    notSuppported: new Glean._private.CounterMetricType({
      category: "service",
      name: "not_suppported",
      sendInPings: ["custom"],
      lifetime: "ping",
     ...
     */
    langMismatch: new Glean._private.CounterMetricType({
      category: "service",
      name: "lang_mismatch",
      sendInPings: ["custom"],
      lifetime: "ping",
