...
export class TestDomTranslator extends MinimalDomTranslator {
  private texts = {
    ...
    en: [
      ...
      '<div id="n0"><br><b id="n1">(50 years ago):</b> Chandrasekhara Raman, <b id="n2">Indian physicist</b> dies (n. 1888; in the <b id="n3">image), Nobel laureate</b> in 1930.</div>',
      '<div id="n0"> the free-content encyclopedia that everyone<br>can <b id="n1">edit</b></div>',
